...
# Wordclouds for fit 3

```{r wordcloud3, fig.show= 'hide'}
library(wordcloud)
for (i in 1:K){
  cloud.data<-sort(fit1$topics[i,], decreasing=TRUE)[1:50]
  wordcloud(names(cloud.data), freq=cloud.data, scale=c(3,.10), min.freq=1, rot.per=0, random.order=FALSE, col = 1+ i %% 4)
...
Researchers have applied topic modeling to data analysis questions in a wide range of scholarly disciplines.
...
We've posted our code and article text on github.com. To access these materials, please visit this url: http://github.com/fboehm/aejmc-manuscript-2016
