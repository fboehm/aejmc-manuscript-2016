...
# Inference in topic models
  ...
  Computational implementations of both classes of strategies are freely available for the R statistical computing language. We include code in the appendix.  
