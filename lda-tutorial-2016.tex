...
avaialability of digitized texts, has enabled researchers working at the
...
\section{Wordclouds for fit 1}\label{wordclouds-for-fit-1}

\begin{verbatim}
## Loading required package: RColorBrewer
\end{verbatim}

\section{Wordclouds for fit 2}\label{wordclouds-for-fit-2}

\section{Wordclouds for fit 3}\label{wordclouds-for-fit-3}

\section{Background}\label{background}

Researchers have applied topic modeling to data analysis questions in a
wide range of scholarly disciplines.

\subsubsection{What types of data analysis problems have others
addressed with topic
...
\subsubsection{What types of data?}\label{what-types-of-data}
...
distribution of the parameters. Note that this computational
...
\NormalTok{opts_chunk$}\KeywordTok{set}\NormalTok{(}\DataTypeTok{echo =} \OtherTok{FALSE}\NormalTok{)  }\CommentTok{# hide source code in the document}
...
\NormalTok{stopwords <-}\StringTok{ }\NormalTok{tm::}\KeywordTok{stopwords}\NormalTok{(}\StringTok{"SMART"}\NormalTok{)}
